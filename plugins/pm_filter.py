...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("നിങ്ങൾ ചോദിച്ച സിനിമ ഏതാണെന്നു എനിക്ക് മനസിലായില്ല.\nതാഴെ ഉള്ളതിൽ ഏതെങ്കിലും ആണോ🤔ആണെങ്കിൽ അതിൽ ക്ലിക്ക് ചെയ്യ്.?", reply_markup=InlineKeyboardMarkup(btn))
